...
public class Laptop {
    ...
    String resolution;
    String link;
    String cpuSingleScore;
    String cpuMultiScore;
    String gpuScore;
    ...
    public Laptop(String name, String cpu, String gpu, String battery,
        ...
        this.cpuSingleScore = cpuSingleScore;
        this.cpuMultiScore = cpuMultiScore;
    ...
    public String toCSV() {
        return name + "," + cpu + "," + gpu + "," + battery + "," +
                weight + "," + screenSize + "," + resolution + "," + cpuSingleScore + "," + cpuMultiScore + "," + gpuScore + "," + link;
    }
}
